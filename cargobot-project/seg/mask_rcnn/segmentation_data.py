# TODO: Change this to the three camera setup.  Make sure to pull images 
from
# both bins.

# TODO: Compute mean and std for dataset and add the normalization 
transform.
# 
...
plant.get_body(body_index), tf)
        ...
        try:
            ...
            # I've chosen an aggressive simulation time step which works 
most
...
if args.test or debug:
    ...
    list(tqdm(pool.imap(generate_image, range(num_images)), 
total=num_images))
    pool.close()
    pool.join()
