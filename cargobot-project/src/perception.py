...
def BoxSystem():
    ...
    parser.AddModels("/usr/cargobot/cargobot-project/res/box_with_cameras.dmd.yaml")
    plant.Finalize()
...
directives:
- add_directives:
    file: file:///usr/cargobot/cargobot-project/res/iiwa_and_wsg.dmd.yaml
- add_directives:
    file: file:///usr/cargobot/cargobot-project/res/warehouse_w_cameras.dmd.yaml
- add_model:
    name: box-vertical
    file: file:///usr/cargobot/cargobot-project/res/box-vertical.urdf
